...
def SSD(input_shape, num_classes=21):
    ...
    # importing VGG16 block
    conv4_3, fc7 = VGG16(input_layer)
    ...
    conv4_3_norm_mbox_priorbox = AnchorBox(
        img_size,
        30.0,
    ...
    fc7_mbox_priorbox = AnchorBox(img_size, 60.0,
    ...
    conv6_2_mbox_priorbox = AnchorBox(img_size, 114.0,
                                      max_size=168.0,
                                      aspect_ratios=[2, 3],
                                      variances=[0.1, 0.1, 0.2, 0.2],
    ...
    conv7_2_mbox_priorbox = AnchorBox(img_size, 168.0,
                                      max_size=222.0,
                                      aspect_ratios=[2, 3],
                                      variances=[0.1, 0.1, 0.2, 0.2],
    ...
    conv8_2_mbox_priorbox = AnchorBox(img_size, 222.0,
                                      max_size=276.0,
                                      aspect_ratios=[2, 3],
                                      variances=[0.1, 0.1, 0.2, 0.2],
    ...
    pool6_mbox_priorbox = AnchorBox(
        img_size, 276.0, max_size=330.0, aspect_ratios=[
            2, 3], variances=[
            0.1, 0.1, 0.2, 0.2], name='pool6_mbox_priorbox')(pool6_reshaped)
